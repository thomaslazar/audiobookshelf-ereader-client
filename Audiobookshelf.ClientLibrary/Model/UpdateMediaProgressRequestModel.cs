...
{
    /// <summary>
    /// UpdateMediaProgressRequestModel
    /// </summary>
    [DataContract(Name = "UpdateMediaProgressRequest")]
    public partial class UpdateMediaProgressRequestModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMediaProgressRequestModel" /> class.
        /// </summary>
        ...
        public UpdateMediaProgressRequestModel(float duration = default(float), float progress = default(float), float currentTime = default(float), bool isFinished = default(bool), bool hideFromContinueListening = default(bool), long? finishedAt = default(long?), long startedAt = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateMediaProgressRequestModel {\n");
