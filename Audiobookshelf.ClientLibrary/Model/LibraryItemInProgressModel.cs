...
{
    /// <summary>
    /// A library item including progress information.
    /// </summary>
    [DataContract(Name = "LibraryItemInProgress")]
    public partial class LibraryItemInProgressModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LibraryItemInProgressModel" /> class.
        /// </summary>
        ...
        public LibraryItemInProgressModel(string id = default(string), string ino = default(string), string libraryId = default(string), string folderId = default(string), string path = default(string), string relPath = default(string), bool isFile = default(bool), long mtimeMs = default(long), long ctimeMs = default(long), long birthtimeMs = default(long), long addedAt = default(long), long updatedAt = default(long), bool isMissing = default(bool), bool isInvalid = default(bool), string mediaType = default(string), LibraryItemMinifiedMediaModel media = default(LibraryItemMinifiedMediaModel), int numFiles = default(int), int size = default(int), long progressLastUpdate = default(long), PodcastEpisodeModel recentEpisode = default(PodcastEpisodeModel))
        {
            ...
            this.Size = size;
            this.ProgressLastUpdate = progressLastUpdate;
        ...
        /// </summary>
        /// <value>The time (in ms since POSIX epoch) when the corresponding media progress was last updated.</value>
        [DataMember(Name = "progressLastUpdate", EmitDefaultValue = false)]
        public long ProgressLastUpdate { get; set; }

        /// <summary>
        /// Gets or Sets RecentEpisode
        /// </summary>
        [DataMember(Name = "recentEpisode", EmitDefaultValue = false)]
        public PodcastEpisodeModel RecentEpisode { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LibraryItemInProgressModel {\n");
            ...
            sb.Append("  ProgressLastUpdate: ").Append(ProgressLastUpdate).Append("\n");
            sb.Append("  RecentEpisode: ").Append(RecentEpisode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
