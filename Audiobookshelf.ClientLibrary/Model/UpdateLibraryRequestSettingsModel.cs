...
{
    /// <summary>
    /// UpdateLibraryRequestSettingsModel
    /// </summary>
    [DataContract(Name = "UpdateLibraryRequest_settings")]
    public partial class UpdateLibraryRequestSettingsModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLibraryRequestSettingsModel" /> class.
        /// </summary>
        /// <param name="coverAspectRatio">coverAspectRatio.</param>
        /// <param name="disableWatcher">disableWatcher.</param>
        /// <param name="skipMatchingMediaWithAsin">skipMatchingMediaWithAsin.</param>
        /// <param name="skipMatchingMediaWithIsbn">skipMatchingMediaWithIsbn.</param>
        /// <param name="autoScanCronExpression">autoScanCronExpression.</param>
        public UpdateLibraryRequestSettingsModel(int coverAspectRatio = default(int), bool disableWatcher = default(bool), bool skipMatchingMediaWithAsin = default(bool), bool skipMatchingMediaWithIsbn = default(bool), string autoScanCronExpression = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateLibraryRequestSettingsModel {\n");
