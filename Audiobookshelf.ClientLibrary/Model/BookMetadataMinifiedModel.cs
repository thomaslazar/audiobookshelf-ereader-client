...
namespace Audiobookshelf.ClientLibrary.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BookMetadataMinified")]
    public partial class BookMetadataMinifiedModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookMetadataMinifiedModel" /> class.
        /// </summary>
        ...
        /// <param name="subtitle">The subtitle of the book..</param>
        /// <param name="authorName">The name of the book&#39;s author(s)..</param>
        /// <param name="authorNameLF">The name of the book&#39;s author(s) with last names first..</param>
        /// <param name="narratorName">The name of the audiobook&#39;s narrator(s)..</param>
        /// <param name="seriesName">The name of the book&#39;s series..</param>
        /// <param name="genres">The genres of the book..</param>
        /// <param name="publishedYear">The year published..</param>
        /// <param name="publishedDate">The date published..</param>
        /// <param name="publisher">The publisher..</param>
        /// <param name="description">A description for the book..</param>
        /// <param name="isbn">The ISBN..</param>
        /// <param name="asin">The ASIN..</param>
        /// <param name="language">The language..</param>
        /// <param name="varExplicit">Whether the book is explicit..</param>
        /// <param name="abridged">Whether the book is abridged..</param>
        public BookMetadataMinifiedModel(string title = default(string), string titleIgnorePrefix = default(string), string subtitle = default(string), string authorName = default(string), string authorNameLF = default(string), string narratorName = default(string), string seriesName = default(string), List<string> genres = default(List<string>), string publishedYear = default(string), string publishedDate = default(string), string publisher = default(string), string description = default(string), string isbn = default(string), string asin = default(string), string language = default(string), bool varExplicit = default(bool), bool abridged = default(bool))
        {
            this.Title = title;
        ...
        /// </summary>
        /// <value>The subtitle of the book.</value>
        ...
        /// </summary>
        /// <value>The name of the book&#39;s author(s) with last names first.</value>
        ...
        /// </summary>
        /// <value>The name of the audiobook&#39;s narrator(s).</value>
        ...
        /// </summary>
        /// <value>The name of the book&#39;s series.</value>
        ...
        /// The year published.
        /// </summary>
        /// <value>The year published.</value>
        ...
        /// </summary>
        /// <value>A description for the book.</value>
        ...
        /// <summary>
        /// Whether the book is explicit.
        /// </summary>
        /// <value>Whether the book is explicit.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BookMetadataMinifiedModel {\n");
