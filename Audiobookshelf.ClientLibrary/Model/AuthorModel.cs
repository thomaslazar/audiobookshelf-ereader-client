...
namespace Audiobookshelf.ClientLibrary.Model
{
    ...
    public partial class AuthorModel : IValidatableObject
    {
        /// <summary>
        ...
        public AuthorModel(string id = default(string), string asin = default(string), string name = default(string), string description = default(string), string imagePath = default(string), long addedAt = default(long), long updatedAt = default(long))
        {
            this.Id = id;
            this.Asin = asin;
            this.Name = name;
