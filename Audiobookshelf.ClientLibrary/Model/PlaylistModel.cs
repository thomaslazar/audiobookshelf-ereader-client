...
namespace Audiobookshelf.ClientLibrary.Model
{
    ...
    public partial class PlaylistModel : IValidatableObject
    {
        /// <summary>
        ...
        public PlaylistModel(string id = default(string), string libraryId = default(string), string userId = default(string), string name = default(string), string description = default(string), string coverPath = default(string), List<PlaylistItemModel> items = default(List<PlaylistItemModel>), long lastUpdate = default(long), long createdAt = default(long))
        {
            this.Id = id;
