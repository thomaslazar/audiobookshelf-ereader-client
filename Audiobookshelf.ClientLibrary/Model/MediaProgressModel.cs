...
namespace Audiobookshelf.ClientLibrary.Model
{
    ...
    /// Media Progress
    /// </summary>
    [DataContract(Name = "MediaProgress")]
    public partial class MediaProgressModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaProgressModel" /> class.
        /// </summary>
        ...
        public MediaProgressModel(string id = default(string), string libraryItemId = default(string), string episodeId = default(string), decimal duration = default(decimal), decimal progress = default(decimal), decimal currentTime = default(decimal), bool isFinished = default(bool), bool hideFromContinueListening = default(bool), long lastUpdate = default(long), long startedAt = default(long), long? finishedAt = default(long?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MediaProgressModel {\n");
